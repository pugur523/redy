...
enum class DiagnosticId : uint8_t {
  ...
  kCannotBePostfixOperator = 15,
  kUnexpectedKeyword = 16,
  kMalformedDeclaration = 17,
  kDuplicateParameterName = 18,
  kParameterCountMismatch = 19,
  kInvalidFunctionCall = 20,
  kInvalidAssignmentTarget = 21,
  kInvalidGenericArguments = 22,
  kBreakOutsideLoop = 23,
  kContinueOutsideLoop = 24,
  kConflictingStorageSpecifiers = 25,
  kInvalidPattern = 26,
  kInvalidSyntax = 27,  // fallback

  // ast analyze (symbol, type)
  kUndefinedSymbol = 28,
  kUndefinedVariable = 29,
  kUndefinedFunction = 30,
  kUndefinedType = 31,
  kCallArgumentMismatch = 32,
  kReturnTypeMismatch = 33,
  kNonCallableExpression = 34,
  kInvalidOperatorOperands = 35,
  kMemberNotFound = 36,
  kAccessPrivateMember = 37,
  kImmutableBindingChanged = 38,
  kConstAssignment = 39,
  kTypeMismatch = 40,
  kTypeAnnotationRequired = 41,
  kNonIterableExpression = 42,
  kInfiniteLoopLiteral = 43,
  kFunctionSignatureMismatch = 44,
  kRedeclaration = 45,
  kConflictingDeclaration = 46,
  kConflictingTraitImplementation = 47,
  kMissingTraitBound = 48,
  kVariableNotInitialized = 49,
  kMisplacedAttribute = 50,
  kRecursiveTypeDefinition = 51,
  kCyclicDependency = 52,
  kNumericLiteralOutOfRange = 53,

  // hir / mir analyze (lifetime infer/ borrow checker)
  kDanglingReference = 54,
  kUnusedLifetimeParameter = 55,
  kUnusedBorrow = 56,
  kLifetimeConflict = 57,
  kLifetimeAnnotationRequired = 58,
  kReturnedBorrowDoesNotLiveLongEnough = 59,
  kMovedVariableThatWasStillBorrowed = 60,
  kBorrowAfterMove = 61,
  kUseAfterMove = 62,
  kMultipleMutableBorrow = 63,
  kMutableAlias = 64,
  kImmutableBorrowIntoMutable = 65,

  // warning
  kUnusedVariable = 66,
  kUnusedFunction = 67,
  kUnreachableCode = 68,
  kImplicitConversion = 69,
  kMissingReturnStatement = 70,
  kDeprecatedFeature = 71,
  kDeprecatedApiUsage = 72,
  kAmbiguousCall = 73,
  kUnnecessaryCopy = 74,
  kShadowingVariable = 75,
  kNumericDivisionByZero = 76,
  kAlwaysTrueCondition = 77,
  kAlwaysFalseCondition = 78,
  kMissingDefaultCase = 79,
  kInefficientLoop = 80,
  kRedundantCast = 81,
  kEmptyLoopBody = 82,
  kIneffectiveAssignment = 83,
};
