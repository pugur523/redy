...
enum class DiagnosticId : uint8_t {
  ...
  kMalformedDeclaration = 24,
  kDuplicateParameterName = 25,
  kParameterCountMismatch = 26,
  kInvalidFunctionCall = 27,
  kInvalidAssignmentTarget = 28,
  kInvalidGenericArguments = 29,
  kBreakOutsideLoop = 30,
  kContinueOutsideLoop = 31,
  kInvalidPattern = 32,
  kInvalidSyntax = 33,  // fallback

  // sema (related to declaration & type)
  kUndefinedSymbol = 34,
  kUndefinedVariable = 35,
  kUndefinedFunction = 36,
  kUndefinedType = 37,
  kCallArgumentMismatch = 38,
  kReturnTypeMismatch = 39,
  kNonCallableExpression = 40,
  kInvalidOperatorOperands = 41,
  kMemberNotFound = 42,
  kAccessPrivateMember = 43,
  kImmutableBindingChanged = 44,
  kConstAssignment = 45,
  kTypeMismatch = 46,
  kTypeAnnotationRequired = 47,
  kNonIterableExpression = 48,
  kInfiniteLoopLiteral = 49,
  kFunctionSignatureMismatch = 50,
  kRedeclaration = 51,
  kConflictingDeclaration = 52,
  kConflictingTraitImplementation = 53,
  kMissingTraitBound = 54,
  kVariableNotInitialized = 55,
  kMisplacedAttribute = 56,
  kRecursiveTypeDefinition = 57,
  kCyclicDependency = 58,
  kNumericLiteralOutOfRange = 59,
